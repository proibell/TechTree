...
export default function SettingsPanel() {
  ...
  return (
    <div
      className={`flex flex-col transition-all duration-300 border-r ${pixelStyle ? (darkMode ? 'bg-gray-900 border-gray-700' : 'bg-gray-800 border-gray-600') : (darkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200')} ${
                ...
                {categoryConfigs.map((config) => (
                  ...
                  >
                    ...
                    <input
                      ...
                      className={`flex-1 px-2 py-1 text-sm border ${pixelStyle ? '' : 'rounded'} ${pixelStyle ? (darkMode ? 'bg-gray-700 border-gray-500 text-gray-200' : 'bg-gray-600 border-gray-400 text-gray-200') : (darkMode ? 'bg-gray-600 border-gray-500 text-gray-100 placeholder-gray-400' : 'border-gray-300')}`}
                      placeholder="分类标签"
