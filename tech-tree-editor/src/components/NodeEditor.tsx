...
export default function NodeEditor() {
  const { nodes, connections, selectNode, selectNodes, selectedNodeIds, addNode, deleteNode, cancelConnection, addingConnection, connectionStyle, setConnectionStyle, moveNode, getRelatedNodeIds, theme, setTheme, copyNodes, pasteNodes } = useNodeStore();
